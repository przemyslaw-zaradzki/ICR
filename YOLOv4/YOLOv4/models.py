...
from YOLOv4.YOLOv4.tool.utils import *
...
def Yolo_predict():
    n_classes = 13
    weightfile = "YOLOv4/YOLOv4/checkpoints/Yolov4_epoch10.pth"
    imgfile = "static\images\chessboard.jpg"
    namesfile = "YOLOv4/YOLOv4/test/_classes.txt"
